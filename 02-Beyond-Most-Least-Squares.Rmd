...
kable(table2chp2, booktabs=T,caption="The likelihood factors for the hypothetical data set of n=50 children.", escape=F)
```
...
kable(table3chp2, booktabs=T,caption="Family contributions to the likelihood for a Sex Conditional Model using a hypothetical data set  of n=50 children from 30 families.",escape=F)
```
...
kable(table9chp2, booktabs=T,caption="Likelihood contributions for families in Model 3: Waiting for a boy.",escape=F)
```
