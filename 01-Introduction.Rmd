...
```{r OLSassumptions, fig.align = "center", out.width = "100%", fig.cap = 'Ordinary least squares assumptions', echo=FALSE}
...
```{r twohist, fig.align = "center", out.width="100%", fig.cap = 'Histograms of key continuous variables.  Plot (a) shows winning speeds, while plot (b) shows the number of starters.', echo=FALSE, message=FALSE}
# EDA graphs
...
```{r bivariate, fig.align = "center", out.width = "100%", fig.cap = 'Relationships between pairs of variables in the Kentucky Derby data set', echo=FALSE, warning=FALSE, message = FALSE}
...
```{r codeds, fig.align = "center", out.width = "100%", fig.cap = 'Linear trends in winning speeds over time, presented separately for fast conditions vs. good or slow conditions', echo=FALSE, warning=FALSE}
# Coded scatterplot
...
```{r center, fig.align = "center", out.width = "100%", fig.cap = 'Compare Model 1 (with intercept at 0) to Model 2 (with intercept at 1896)', echo=FALSE, warning=FALSE}
...
```{r resid2, fig.align = "center", out.width = "100%", fig.cap = 'Residual plots for Model 2', echo=FALSE, warning=FALSE}
...
```{r models2and2q, fig.align = "center", out.width = "100%", fig.cap = 'Linear vs. quadratic fit', echo=FALSE, warning=FALSE}
...
```{r resid2q, fig.align = "center", out.width = "100%", fig.cap = 'Residual plots for Model 2Q', echo=FALSE, warning=FALSE}
# Residual diagnostics for Model 2
par(mfrow=c(2,2))
plot(model2q)
par(mfrow=c(1,1))
...
```{r boot4, fig.align = "center", out.width = "100%", fig.cap = 'Bootstrapped distributions for Model 4 coefficients', echo=FALSE, warning=FALSE}
