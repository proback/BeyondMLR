...
```{r OLSassumptions, fig.align = "center", out.width = "90%", fig.cap = 'Assumptions for linear least squares regression (LLSR)', echo=FALSE}
...
summ(model1, digits = 3, model.info = FALSE)
```
...
summ(model2, digits = 3, model.info = FALSE)
```
...
summ(model2q, digits = 4, model.info = FALSE)
```
...
summ(model3, digits = 3, model.info = FALSE)
```
...
summ(model4, digits = 3, model.info = FALSE)
```
