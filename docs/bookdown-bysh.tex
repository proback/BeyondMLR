...
\item
  ...
  \def\labelenumii{\alph{enumii}.}
  \item
    Fill out Table \ref{tab:table10chp2}---write out the contribution of each game to the likelihood for both models along with the total likelihood for each model.
  \item
