...
Much like OLS, using **logistic regression** \index{logistic regression} to make inferences requires model assumptions.
...
Another approach available in R is the **profile likelihood method** \index{profile likelihood}, similar to Chapter \@ref(ch-poissonreg).
...
## Linear Least Squares Regression \index{linear least squares regression (LLSR)} vs. Binomial Logistic Regression \index{binomial logistic regression}
