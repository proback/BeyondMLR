...
kab1chp9 <- kable(table1chp9) %>%
  kable_styling(bootstrap_options = c("striped")) %>%
  column_spec(column = 1:2, width = "18em; min-width: 15em;")

ifelse(knitr::is_html_output(),kab1chp9 %>% scroll_box(width="100%"),kab1chp9)
```
...
int.scat1 <- ggplot(chart.wide,aes(x=100*schPctfree,y=int)) + geom_point() + 
  theme.1 + 
  labs(x="Percent Free and Reduced Lunch",y="Fitted Intercepts",title="(b)") + 
...
# Modeling piecewise linear time trend (even though only 3 time points)
chart.long <- chart.long %>%
...
##Code after the final figure - playing around with potential final models
##  using lmer and lme
